...
def on_connect( client, userdata, flags, rc):
    ...
    client.subscribe("semanatecIOT_Eq2")
...
def envia_mensaje():
    ...
    autor_salida   = input('Autor:')
    client.publish("semanatecIOT_Eq2",'Autor:'+autor_salida)
    client.publish("semanatecIOT_Eq2",mensaje_salida)
    print('----------------------------------------')
    #time.sleep(4)
